window.addEventListener('load', function(){            //window load event listener
    //canvas setup
    ...
    class Player {                                        
        ...
        shootTop(){
            if (this.game.ammo > 0){
                this.projectiles.push(new Projectile(this.game, this.x + 116, this.y + 30));
                this.game.ammo--;
            }
        ...
        shootBottom(){
            if (this.game.ammo > 0){
                this.projectiles.push(new Projectile(this.game, this.x + 116, this.y + 175));
                this.game.ammo--;
            }
        }
        enterPowerUp(){
